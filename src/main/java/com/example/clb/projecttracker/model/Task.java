...
public class Task {
    ...
    // toString, equals, and hashCode are generated by @Data
    // Be mindful of bi-directional relationships if not using @ToString.Exclude / @EqualsAndHashCode.Exclude
    // For Project and Developer, we already excluded their task collections.
}
